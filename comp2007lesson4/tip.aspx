<%@ Page Title="" Language="C#" MasterPageFile="~/lesson4.Master" AutoEventWireup="true" CodeBehind="tip.aspx.cs" Inherits="comp2007lesson4.tip" %>
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
    ...
    <div class="form-group">
        ...
        <asp:RequiredFieldValidator ID="RequiredFieldValidator1" runat="server" ErrorMessage="Please enter bill amount." ControlToValidate="txtAmount" CssClass="alert-danger"></asp:RequiredFieldValidator>
        <asp:RangeValidator ID="RangeValidator1" Type="Double" MaximumValue="999999999999" MinimumValue="0.01" runat="server" ControlToValidate="txtAmount" ErrorMessage="Enter a numberical value greater than zero" CssClass="alert-danger"></asp:RangeValidator>
    </div>
    <div class="form-group">
